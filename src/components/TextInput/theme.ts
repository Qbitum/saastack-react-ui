...
export const textInputTheme: FlowbiteTextInputTheme = {
  ...
  field: {
    ...
    input: {
      ...
      colors: {
        gray: 'border-themeGray-80 bg-white text-defultText placeholder-themeGray-80 focus:border-themeGray-200 focus:ring-themeGray-80 dark:border-cyan-400 dark:bg-cyan-100 dark:focus:border-cyan-500 dark:focus:ring-cyan-500',
