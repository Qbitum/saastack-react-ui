...
export const checkboxTheme: FlowbiteCheckboxTheme = {
  root: {
    base: 'h-4 w-4 rounded focus:ring-1 border border-themeGray-100 dark:border-gray-600 dark:bg-gray-700 bg-themeGray-60',
    color: {
      default: 'focus:ring-primary-60 dark:ring-offset-gray-800 dark:focus:ring-cyan-600 text-primary-100',
      failure: 'focus:ring-themeFailure-60 dark:ring-offset-red-900 dark:focus:ring-red-900 text-themeFailure-100',
      info: 'focus:ring-themeInfo-60 dark:ring-offset-gray-800 dark:focus:ring-cyan-800 text-themeInfo-100',
      success: 'focus:ring-themeSuccess-60 dark:ring-offset-green-800 dark:focus:ring-green-800 text-themesuccess-100',
      warning: 'focus:ring-temeWarning-60 dark:ring-offset-yellow-400 dark:focus:ring-yellow-400 text-temeWarning-100',
