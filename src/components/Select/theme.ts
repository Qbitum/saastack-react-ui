  ...
  field: {
    ...
    select: {
      ...
      colors: {
        ...
        warning:
          'border-themeWarning-100 bg-themeWarning-60 text-defultText placeholder-themeFailure-80 focus:border-themeWarning-200 focus:ring-themeWarning-80 dark:border-yellow-400 dark:bg-yellow-100 dark:focus:border-yellow-500 dark:focus:ring-yellow-500',
        success:
