...
export const selectTheme: FlowbiteSelectTheme = {
  ...
  color: {
    ...
    blue: '',
    // 'text-white bg-blue-700 border border-transparent enabled:hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 text-xs',
