...
export const sidebarTheme: FlowbiteSidebarTheme = {
  ...
  collapse: {
    button: 'group flex w-full items-center rounded-lg text-base font-normal text-gray-900 transition duration-75 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 ',
    icon: {
  ...
  itemGroup: {
    base: 'text-blue-200 space-y-5 px-4 mb-1  border-gray-200 first:mt-0 first:border-t-0 dark:border-gray-700 ',
  },
  logo: {
  ...
  bottomItem:  {
    base: 'flex items-center justify-center p-0.5 m-1 rounded-lg text-sm font-normal hover:text-teal-800 hover:bg-red-200 dark:text-white dark:hover:bg-gray-700  ',
    active: 'bg-blue-50 dark:bg-gray-800 rounded-lg ',
    collapsed: {
      insideCollapse: 'group pl-2 transition duration-75 hover:w-5 hover:h-8 ',
      noIcon: 'font-bold',
