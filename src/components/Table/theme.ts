...
export const tableTheme: FlowbiteTableTheme = {
  ...
  body: {
    base: 'group/body',
    cell: {
      base: 'group-first/body:group-first/row:first:rounded-tl-lg group-first/body:group-first/row:last:rounded-tr-lg group-last/body:group-last/row:first:rounded-bl-lg group-last/body:group-last/row:last:rounded-br-lg px-6 py-3',
    },
  },
  head: {
    base: 'group/head text-xs uppercase text-primary-100 dark:text-gray-400 border-secondary-100 border-y ',
    cell: {
      base: 'group-first/head:first:rounded-tl-lg group-first/head:last:rounded-tr-lg dark:bg-gray-700 px-6 py-2',
    },
  },
  row: {
    base: 'group/row',
