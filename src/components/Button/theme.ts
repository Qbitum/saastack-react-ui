...
export const buttonTheme: FlowbiteButtonTheme = {
  base: 'group flex items-stretch items-center justify-center p-0.5 text-center font-medium relative focus:z-10 focus:outline-none transition-all duration-50 ease-in uppercase min-w-32',
  fullSized: 'w-full',
  color: {
    ...
    success: 'text-btntext-themeSuccess bg-themeSuccess-100 border border-transparent enabled:hover:bg-themeSuccess-200 focus:ring-4 focus:ring-themeSuccess-60 dark:bg-green-600 dark:enabled:hover:bg-green-700 dark:focus:ring-green-800',

    warning: 'text-btntext-themeWarning bg-themeWarning-100 border border-transparent enabled:hover:bg-themeWarning-200 focus:ring-4 focus:ring-themeWarning-60 dark:focus:ring-yellow-900',
  ...
  gradient: {
    ...
    failure: 'text-btntext-themeFailure bg-gradient-to-b from-themeFailure-80 via-themeFailure-100 to-themeFailure-200 enabled:hover:bg-gradient-to-t focus:ring-4 focus:ring-themeFailure-60',
    success: 'text-btntext-themeSuccess bg-gradient-to-b from-themeSuccess-80 via-themeSuccess-100 to-themeSuccess-200 enabled:hover:bg-gradient-to-t focus:ring-4 focus:ring-themeSuccess-60',
  ...
  inner: {
    ...
    clear: 'border border-transparent bg-transparent'
  },
  ...
  outline: {
    color: {
      ...
      dark: 'border border-gray-800 bg-white',
      light: '',
      blue: 'border border-blue-700 bg-white',
      green: 'border border-green-700 bg-white',
      yellow: 'border border-yellow-700 bg-white',
      red: 'border border-red-700 bg-white',
      cyan: 'border border-cyan-700 bg-white',
      purple: 'border border-purple-700 bg-white',
      pink: 'border border-pink-700 bg-white',
      default: 'border-0',
    },
    off: '',
  ...
  clear:{
    color: {
      ...
      dark: 'border border-gray-800 bg-white',
      light: '',
      blue: 'border border-transparent bg-white',
      green: 'border border-transparent bg-white',
      yellow: 'border border-yellow-700 bg-white',
      red: 'border border-red-700 bg-white',
      cyan: 'border border-cyan-700 bg-white',
      purple: 'border border-purple-700 bg-white',
    ...
    off: '',
    on: 'flex justify-center bg-transparent text-gray-900 transition-all duration-75 ease-in group-enabled:group-hover:bg-opacity-0 group-enabled:group-hover:text-inherit dark:bg-gray-900 dark:text-white w-full text-secondary-100',
    pill: {
      off: 'rounded-md',
      on: 'rounded-full',
    },
