...
export const buttonTheme: FlowbiteButtonTheme = {
  ...
  gradient: {
    primary:
      'text-btntext-primary bg-gradient-to-b from-primary-80 via-primary-100 to-primary-200 enabled:hover:bg-gradient-to-t focus:ring-4 focus:ring-primary-60',

    secondary:
      'text-btntext-secondary bg-gradient-to-b from-secondary-80 via-secondary-100 to-secondary-200 enabled:hover:bg-gradient-to-t focus:ring-4 focus:ring-secondary-60',

    tertiary:
      'text-btntext-tertiary bg-gradient-to-b from-tertiary-80 via-tertiary-100 to-tertiary-200 enabled:hover:bg-gradient-to-t focus:ring-4 focus:ring-tertiary-60',
    ...
    warning:
      'text-btntext-themeWarning bg-gradient-to-b from-themeWarning-80 via-themeWarning-100 to-themeWarning-200 enabled:hover:bg-gradient-to-t focus:ring-4 focus:ring-themeWarning-60',
    ...
    green:
      'text-white bg-gradient-to-b from-green-400 via-green-500 to-green-600 enabled:hover:bg-gradient-to-t focus:ring-4 focus:ring-green-300 dark:focus:ring-green-800',
    ...
    yellow:
      'text-white bg-gradient-to-b from-yellow-400 via-yellow-500 to-yellow-600 enabled:hover:bg-gradient-to-t focus:ring-4 focus:ring-yellow-300 dark:focus:ring-yellow-800',
    ...
    purple:
      'text-white bg-gradient-to-b from-purple-500 via-purple-600 to-purple-700 enabled:hover:bg-gradient-to-t focus:ring-4 focus:ring-purple-300 dark:focus:ring-purple-800',
