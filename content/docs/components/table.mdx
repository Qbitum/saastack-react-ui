---
title: React Tables - Saastack React UI
...
Use the custom React components from Saastack React UI and the API reference of props to customize the table layout and content and the utility classes from Tailwind CSS to update the styles.

Start using the table component by importing it from the `@qbitum/react-flat-ui` library:
...
- [Saastack React UI Table](https://flowbite.com/docs/components/tables/)
