---
title: React Avatar - Saastack React UI
...
The avatar component from Saastack React UI can be used to show a visual representation of a user or team account for your application based on multiple examples, colors, sizes and shapes.
...
To start using the avatar component you need to import it from the `@qbitum/react-flat-ui` package:
...
- [Saastack React UI Avatar](https://flowbite.com/docs/components/avatar/)
