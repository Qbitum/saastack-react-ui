---
title: React Progress Bar - Saastack React UI
...
Use the progress bar component from Saastack React UI to show the percentage and completion rate of a given task using a visually friendly bar meter based on multiple styles and sizes.
...
To start using the progress bar component make sure you import it first from Saastack React UI:
...
- [Saastack React UI Progress Bar](https://flowbite.com/docs/components/progress/)
