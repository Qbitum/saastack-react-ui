---
title: React Sticky Banner - Saastack React UI
...
Get started with the sticky banner component coded with Tailwind CSS and Saastack React UI to show marketing, informational and CTA messages to your website visitors fixed to the top or bottom part of the page as the user scroll down the main content area.
...
To start using the banner component you need to import it from `@qbitum/react-flat-ui`:
...
- [Saastack React UI Banner](https://flowbite.com/docs/components/banner/)
