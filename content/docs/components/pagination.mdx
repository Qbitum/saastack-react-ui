---
title: React Pagination - Saastack React UI
...
You need to import the pagination component from the `@qbitum/react-flat-ui` library before using it:
...
- [Saastack React UI Pagination](https://flowbite.com/docs/components/pagination/)
