---
title: React KBD (Keyboard) - Saastack React UI
...
To start using the `<Kbd>` component you need to import it from `@qbitum/react-flat-ui`:
...
- [Saastack React UI Kbd](https://flowbite.com/docs/components/kbd/)
