---
title: React Forms - Saastack React UI
description: Use the forms elements from Saastack React UI to start receiving user input data based on input elements, checkboxes, radio buttons, file uploads based on multiple sizes, colors, and styles
---

The form elements from Saastack React UI can help you to collect input data from your website visitors by using input field elements, checkboxes, radios, file upload elements, and more based on React and Tailwind CSS.

These components can be used to create form submission pages, authentication features for your users and you can use the elements together with other components from Saastack React UI such as with modals, cards, and more.

Check out the form elements from Saastack React UI on this page and customize the value and options using the React props API and customize the styles using Tailwind CSS.

Make sure that you import the appropiate components from the `@qbitum/react-flat-ui` library:
...
- [Saastack React UI Forms](https://flowbite.com/docs/components/forms/)
