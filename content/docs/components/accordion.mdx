---
title: React Accordion - Saastack React UI
...
The accordion component from Saastack React UI can be used to toggle the visibility of the content of each accordion panel tab by expanding the collapsing the trigger element based on multiple examples and styles.
...
To use the accordion component, you need to import the `<Accordion>` component from `@qbitum/react-flat-ui`:
...
- [Saastack React UI Accordion](https://flowbite.com/docs/components/accordion/)
