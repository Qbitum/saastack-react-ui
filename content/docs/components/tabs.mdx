---
title: React Tabs - Saastack React UI
description: Get started with the tabs component from Saastack React UI to show a list of tab items where you can switch between them using multiple styles, colors and layouts
---
...
Make sure that you import the component from the `@qbitum/react-flat-ui` library:
...
- [Saastack React UI Tabs](https://flowbite.com/docs/components/tabs/)
