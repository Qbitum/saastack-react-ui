---
title: React Footer - Saastack React UI
...
Get started with the examples from Saastack React UI based on multiple styles, sizes, and colors by using React components and the utility classes from Tailwind CSS.

To start using the footer component you need to import it from `@qbitum/react-flat-ui`:
...
- [Saastack React UI Footer](https://flowbite.com/docs/components/footer/)
