---
title: React Datepicker - Saastack React UI
...
The Datepicker component from Saastack React UI is an advanced UI element that you can use to allow users to pick a date from a calendar view by selecting the day, month, and year values which then will be available in the input field and state of the component.

Follow the examples below to see how you can use the Datepicker component by importing it from the Saastack React UI library, customize the colors and behaviour of the component by overriding the default theme variables and using the props from React.

Import the component from `@qbitum/react-flat-ui` to use the datepicker element:
...
- [Saastack React UI Datepicker](https://flowbite.com/docs/plugins/datepicker/)
