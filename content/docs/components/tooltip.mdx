---
title: React Tooltip - Saastack React UI
...
Use the tooltip component from Saastack React UI to indicate helpful information when hovering over an element such as a button or link to improve the UI/UX of your website.
...
```jsx
import { Tooltip } from '@qbitum/react-flat-ui';
```
...
- [Saastack React UI Tooltip](https://flowbite.com/docs/components/tooltips/)
