---
title: React Rating - Saastack React UI
description: Get started with the rating component from Saastack React UI to show testimonials and user reviews of your products using stars, labels and advanced layouts
---
...
Check out the rating components from Saastack React UI and choose one that suits your needs and customize them using the custom props API and the utility classes from Tailwind CSS.

Start using the rating component by importing it from the `@qbitum/react-flat-ui` library:
...
- [Saastack React UI Rating](https://flowbite.com/docs/components/rating/)
