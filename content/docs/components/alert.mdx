---
title: React Alert - Saastack React UI
...
To start using the alert box you need to import the `<Alert>` component from the `@qbitum/react-flat-ui` package:
...
- [Saastack React UI Alerts](https://flowbite.com/docs/components/alerts/)
