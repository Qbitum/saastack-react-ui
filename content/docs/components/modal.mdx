---
title: React Modal - Saastack React UI
...
To get started with the modal component you first need to import it from Saastack React UI:

```jsx
import { Modal } from '@qbitum/react-flat-ui';
```
...
- [Saastack React UI Modal](https://flowbite.com/docs/components/modal/)
