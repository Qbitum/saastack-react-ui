---
title: React Badge - Saastack React UI
...
To start using the badge component you need to import it from `Saastack React UI-react`:
...
- [Saastack React UI Badge](https://flowbite.com/docs/components/badge/)
