---
title: React Carousel - Saastack React UI
...
To start using the carousel component you first need to import it from Saastack React UI:
...
- [Saastack React UI Carousel](https://flowbite.com/docs/components/carousel/)
