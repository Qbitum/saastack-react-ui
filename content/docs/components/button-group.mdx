---
title: React Button Group - Saastack React UI
...
The button group component from Saastack React UI can be used to stack multiple button elements and group them visually together. It can often be used to create a navigation menu or a toolbar.
...
To start using the component you need to import it from the Saastack React UI library:
...
- [Saastack React UI Button Group](https://flowbite.com/docs/components/button-group/)
