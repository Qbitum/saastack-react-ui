---
title: React File Input - Saastack React UI
...
Make sure that you have included Saastack React UI as a plugin inside your Tailwind CSS project to apply all the necessary styles for the `<FileInput>` component.

To start using the component make sure that you have imported it from Saastack React UI:

```jsx
import { FileInput } from '@qbitum/react-flat-ui';
```
...
- [Saastack React UI File Input](https://flowbite.com/docs/forms/file-input/)
