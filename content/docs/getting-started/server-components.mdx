---
title: React Server Components (RSC) - Saastack React UI
description: Learn how to use Saastack React UI components inside React Server Components
---
...
All Saastack React UI components are server-ready, meaning they can be rendered inside React Server Components without the need of `'use client'` directive at the top of the file.

Here's a list of all Saastack React UI components that are fully rendered on the server:
...
To pass any user events to a Saastack React UI component (such as `onClick`, `onBlur`) the parent component must have the `'use client'` directive.
